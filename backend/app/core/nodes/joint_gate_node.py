...
Input: state (GraphState with parent_scores and child_scores)
Process:
...
Output: GraphState with final_child_scores and top3_children
"""

from typing import Dict, List
from ..state import GraphState
from ...config.settings import BETA, GAMMA, SINGLE_CHILD_PENALTY
...
def hierarchy_node(state: GraphState) -> GraphState:
    ...
    Returns:
        GraphState: final_child_scores와 top3_children이 업데이트된 상태
    """
