"""ParentScoreNode — INTEGRATION READY
- Calls LLM per sentence using services/llm/scorer.py
- Expects rows already preprocessed
- Returns parent_scores with post-softmax (auto temperature).
"""
from typing import Dict, List
from core.state import GraphState
from services.llm.scorer import score_parents_for_sentences
from utils.softmax import softmax_with_temp, auto_temperature
from core.config import ENTROPY_TARGET_PARENT
import json
